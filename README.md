...
```
cd existing_repo
git remote add origin https://gitlab.com/diasKarataev/library-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/diasKarataev/library-app/-/settings/integrations)
